...
class AppViewSetTests(APITestCase):
    ...
    def test_list_apps_for_authenticated_user_only(self):
        ...
        App.objects.create(name='Another User App', description='Another User App Description', user=another_user)
    ...
    def test_create_app_unauthorized(self):
        response = self.client.post(self.list_url, {'name': 'Unauthorized App', 'description': 'Unauthorized App Description'}, format='json')
